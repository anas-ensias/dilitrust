<template>
  <div class="vue-template">
    <img
      class="d-block mx-auto dilitrustLogo"
      alt="dilitrustLogo"
    ...
    <form class="mx-auto w-50">
      ...
      <button
        ...
        :disabled="! login.length || ! password.length || isLoading"
        @click="performLogin()"
      >
        Sign In
      </button>
      <p class="sign-up text-right mt-2">
        <a
          href="#"
          @click="clearErrors"
        >
...
export default {
  ...
  methods: {
    clearErrors () {
      this.$store.dispatch('security/removeErrors');
